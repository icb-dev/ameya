      ...
      <div className="max-w-[1450px] mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          >
             ...
             <h2 className="text-4xl md:text-[48px] font-serif text-gray-900 PlayfairDisplay tracking-tight">
               Sapphire Residences Floor Plans
             </h2>
          </motion.div>
        </div>
...
export default Residentialfloorplans;